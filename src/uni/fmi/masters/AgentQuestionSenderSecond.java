...
public class AgentQuestionSender extends Agent {
  ...
  private final String[] QUESTION = new String[] { "Списък на възрожденците", "Списък с духовници?",
      "Списък на революционери", "Списък с писателите?", "Списък на рептилите", "Кога е роден Васил Левски?",
      "Истинското име на Васил Левски?", "Кога е умрял Васил Иванов Кунчев", "Къде е роден Васил Левски",
      "Трудове на Васил Левски?", "Кога е роден Иван Вазов", "Иван Вазов е известен с името?",
      "Списък с трудове на Иван Вазов", "Кога е починал Христо Ботев?", "Христо Ботьов Петков е известен още като",
      "Къде е умрял Христо Петков?", "Трудовете на Христо Ботев", "Къде е починал Иван Минчов Вазов",
      "Списък със събития, в които е участвал Васил Левски?", "Списък на активности на Христо Ботев",
      "Дейности на Иван Вазов", "Кои са родени в град Карлово", "Кой е роден в град София?",
      "Кой е умрял в град София?", "Кой е написал Под игото?", "Кога е роден Али Баба?", "Колко е часът?" };
  private int question_current = 0;
  private AID[] answerAgents;

  protected void setup() {
    // System.out.println("QuestionSender agent " + getAID().getName() + " is
    // ready.");
